...
top_screenshots_hint: "התלמידים כותבים קוד ורואים את השינויים בזמן אמת"
#    designed_with: "Designed with teachers in mind"
    real_code: "קוד אמיתי"
    from_the_first_level: "כבר מהשלב הראשון"
...
#    kind_of_struggle: "the kind of struggle that results in learning that’s engaging and"
    motivating: "נותן מוטיבציה"
    not_tedious: "לא מייגע."
    gaming_is_good: "מחקרים מראים שמשחקים טובים למוח הילדים. (זה נכון!)"
...
#    educator_wiki: "Educator Wiki"
    get_involved: "היו מעורבים"
    open_source: "קוד פתוח (גיטהב)"
    support: "תמיכה"
#    faqs: "FAQs"
    help_pref: "צריכים עזרה? שלחו מייל"
    help_suff: "וניצור עמכם קשר!"
...
#    None: "None"
  ...
  login:
    ...
    authenticate_gplus: "אמת באמצעות G+"
    load_profile: "טען פרופיל G+"
    finishing: "מסיים"
    sign_in_with_facebook: "היכנס באמצעות Facebook"
    sign_in_with_gplus: "היכנס באמצעות G+"
    signup_switch: "רוצה ליצור חשבון?"

  signup:
    create_student_header: "צור חשבון תלמיד"
    create_teacher_header: "צור חשבון מורה"
    create_individual_header: "צור חשבן אישי"
    create_header: "צור חשבון"
...
#    last_initial: "Last Initial"
  ...
  play_level:
    ...
    victory_no_progress_for_teachers: "ההתקדמות אינה נשמרת עבור מורים. אבל, ביכולתכם ליצוא חשבון תלמיד משלכם ולצרפו לכיתתכם."
    guide_title: "מדריך"
...
#    check_dev_console: "You can also open the developer console to see what might be going wrong."
    ...
    tip_tell_friends: "נהנה מ-CodeCombat? ספר לחבריך עלינו!"
...
#    tip_mulan: "Believe you can, then you will. - Mulan"
  ...
  subscribe:
    ...
    feature8: "<strong>ללא פרסומות!</strong>"
    free: "חינם"
    month: "חודש"
...
#    editor_config_behaviors_description: "Autocompletes brackets, braces, and quotes."
  ...
  about:
    main_title: "אם אתם רוצים לתכנת, עליכם לכתוב (הרבה מאוד) קוד"
    main_description: "ב-CodeCombat, משימתנו היא לוודא שאתם עושים זאת עם חיוך על הפנים."
    mission_link: "משימתנו" # Translated more as "our mission"
    team_link: "צוות"
    story_link: "סיפור"
    press_link: "עיתונות"
...
#    setup_a_class: "Set Up a Class"
  ...
  account_settings:
    ...
    reset_progress_tab: "אפס התקדמות"
    reset_your_progress: "אפס את כל התקדמותך והתחל מחדש"
    god_mode: "מצב אל"
    password_tab: "סיסמה"
    emails_tab: "אימיילים"
    admin: "אדמין"
    manage_subscription: "לחץ כאן לניהול המנוי."
    new_password: "סיסמה חדשה"
    new_password_verify: "חזור על הסיסמה שנית"
    type_in_email: "הזן את כתובת המייל שלך על מנת לבצע את המחיקה"
    type_in_email_progress: "הכנס את כתובת המייל על מנת לאשר את את מחיקת ההתקדמות."
...
#    social_slack: "Chat with us in the public CodeCombat Slack channel"
  ...
  clans: #TL NOTE: clans were translated as "Tribes" since it's the closest equivalent.
    clan: "שבט"
    clans: "שבטים"
    new_name: "שם שבט חדש"
...
#    private_require_sub: "Private clans require a subscription to create or join."
  ...
  courses:
    course: "קורס"
    courses: "קורסים"
    create_new_class: "מור כיתה חדשה"
...
#    invite_friends_to_battle: "Invite your friends to join you in battle!"
    ...
    defeat_the: "הבס את ה"
    watch_battle: "צפה בקרב"
    tournament_started: ", התחילה"
...
#    blue_ai: "Blue CPU"
    ...
    humans: "האדום" # Ladder page display team name
    ogres: "הכחול"
...
#    you_can3: "that can be applied to your own account or given to others."
  ...
  coppa_deny:
    text1: "לא מסוגל לחכות ללמוד לתכנת?"
    text2: "הוריך יצטרכו ליצור חשבון משתמש עבורך! שלח מייל ל team@codecombat.com אם יש לך שאלות כלשהן."
    close: "סגור חלון"
...
#    connection_failure_desc: "It doesn’t look like you’re connected to the internet! Check your network connection and then reload this page."
    login_required: "נדרשת כניסת חשבון"
...
#    general_desc: "Something went wrong, and it’s probably our fault. Try waiting a bit and then refreshing the page, or visit one of the following links to get back to programming!"
  ...
  concepts:
    advanced_strings: "מחרוזות מורכבות" # Translated "complex" instead of "advanced" strings
    algorithms: "אלגוריתמים"
    arguments: "ארגומנטים"
    arithmetic: "אריתמתיקה"
    arrays: "מערכים"
...
#    bootstrap: "Bootstrap"
  ...
  delta:
    added: "נוסף"
    modified: "שונה"
    not_modified: "לא שונה"
    deleted: "נמחק"
#    moved_index: "Moved Index"
    text_diff: "הבדלי טקסט"
...
#    oreilly: "ebook of your choice"
  ...
  calendar:
    year: "שנה"
    day: "יום" # Might change later to "the"
    month: "חודש"
    january: "ינואר"
    february: "פברואר"
    march: "מרץ"
